...
QT_MOC_LITERAL(1, 7, 13), // "SignalShowOne"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 28) // "on_pushButton_search_clicked"

    },
    "search\0SignalShowOne\0\0"
...
void search::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&search::SignalShowOne)) {
                *result = 0;
                return;
            }
        }
